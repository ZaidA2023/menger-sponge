...
export class MengerAnimation extends CanvasAnimation {
  ...
  public initFloor(): void {
    ...
    // TODO: make a truly infinite floor
    const floorPositions: Float32Array = new Float32Array([
       999.0, this.floorY, -999.0,
      -999.0, this.floorY, -999.0,
       999.0, this.floorY,  999.0,
      -999.0, this.floorY,  999.0
    ]);
    ...
    gl.vertexAttribPointer(
      ...
      3 /* Number of bytes per primitive */,
      gl.FLOAT /* The type of data */,
      false /* Normalize data. Should be false. */,
      0 /* stride */,
      0 /* Initial offset into buffer */
  ...
  public draw(): void {
    ...
    /* Update menger buffers */ //                        AQUI AQUI AQUI
